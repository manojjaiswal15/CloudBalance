                    ...
                    <TableBody>
                        {data.map((data) => (
                            <StyledTableRow key={data.name}>
                                <StyledTableCell className='flex items-center gap-2'>{data.resourceId} <ContentCopyIcon onClick={() => { navigator.clipboard.writeText(params.value) }} /></StyledTableCell>
                                <StyledTableCell>{data.resourceName}</StyledTableCell>
                                {data.engine &&
                                    <StyledTableCell>{data.engine}</StyledTableCell>
                                }
